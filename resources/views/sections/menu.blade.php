...
<div class="content">
    <nav class="left-nav nav flex-column main-menu">
        ...
        <a class="nav-link mb-2 main-link {{Auth::check() ? '' : 'disabled-link'}}" href="{{Auth::check() ? route('my-topics') : 'javascript: return false;'}}" data-bs-toggle="tooltip" data-bs-placement="left" title="">
            <i class="fas fa-plus-square me-2"></i>
            <span>Moje tematy</span>
        </a>
        <a class="nav-link border-0 main-link {{Auth::check() ? '' : 'disabled-link'}}" href="{{Auth::check() ? route('my-answers') : 'javascript: return false;'}}" data-bs-toggle="tooltip" data-bs-placement="left" title="">
